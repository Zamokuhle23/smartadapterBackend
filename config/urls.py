...
urlpatterns = [
    ...
    path("api/quiz/paper/<int:doc_id>/anchors/", PaperAnchorsView.as_view(),
         name="paper-anchors"),
    path("api/quiz/paper/<int:doc_id>/page/<int:page_no>/parts/",
         PaperPagePartsView.as_view(), name="paper-page-parts"),
    path("api/quiz/paper/answer/", PaperAnswerView.as_view(),
         name="paper-answer"),
    path("api/quiz/paper/explain/", PaperExplainView.as_view(),
         name="paper-explain"),
    ...
    path("api/quiz/page-topics/", PageTopicsView.as_view(),
         name="page-topics"),
    path("api/quiz/offline/pack/", OfflinePackView.as_view(),
         name="offline-pack"),
